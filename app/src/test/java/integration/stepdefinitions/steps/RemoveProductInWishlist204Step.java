...
public class RemoveProductInWishlist204Step extends BaseSteps {
    ...
    @Quando("eu faço uma requisição DELETE para remover o produto de id {string} da wishlist do clientId 5")
    ...
    @Entao("a resposta quando o produto for removido da  wishlist deve ter o status code OK {int}")
    public void aRespostaDeveTerOStatusCode200(int statusCode) {
        assertThat(response.getStatusCode().value()).isEqualTo(statusCode);
    }

    @Entao("a ao remover o produto a resposta deve estar vazia")
