...
import com.marvim.wishlist.controller.mapper.AddProductMapper;
import com.marvim.wishlist.controller.mapper.WishlistResponseDtoMapper;
...
public class WishlistController {
    ...
    public ResponseEntity<Void> add(@PathVariable("clientId") String clientId,
        ...
        addProductToWishlistUseCase.execute(clientId, AddProductMapper.toDto(request));
    ...
    public ResponseEntity<ApiResponse<WishlistResponse>> getWishlist(@PathVariable("clientId") String clientId) {
        ...
        WishlistResponse wishlistResponse = WishlistResponseDtoMapper.fromDtoToResponse(getWishlistUseCase.execute(clientId));
